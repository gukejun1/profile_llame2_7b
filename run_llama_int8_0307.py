...
parser.add_argument("--corenums", default=96, type=int, help="corenums")
...
print("=============aaaaa==================")
torch.set_num_threads(args.corenums)
    ...
    if args.profile:
        ...
        with torch.profiler.profile(
            ...
            schedule=torch.profiler.schedule(
                ...
                warmup=0,
                active=1,repeat=1),
            on_trace_ready=torch.profiler.tensorboard_trace_handler("test0313",f"bs{args.batch_size}-output{args.max_new_tokens}-thread{torch.get_num_threads()}-jit{args.jit}"),
            record_shapes=True,
            profile_memory=True,
            with_stack=True
        ) as prof:
